...
def ensure_database_schema(cursor):
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS app_fundamentals (
            ...
            dividend_yield TEXT,
            roe TEXT,
            divida_liquida_patrimonio TEXT,
            margem_bruta TEXT,
            margem_ebit TEXT,
            crescimento_receita_5a TEXT
        )
    ''')
        ...
        if selected_stock:
            ...
            if fundamentus_data:
                ...
                for row_start in range(0, len(indicator_names), 4):
                    ...
                    for column, indicator_name in zip(
                        ...
                        with column:
                            st.metric(indicator_name, fundamentus_data.get(indicator_name, "N/A"))
                st.caption(
            ...
            if history_error:
                ...
                if chart_data.empty:
                    ...
                    st.dataframe(
                        fundamental_history.sort_values("Data", ascending=False),
